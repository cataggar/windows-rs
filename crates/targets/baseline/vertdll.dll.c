...
void __stdcall EnclaveCopyIntoEnclave(int p0, int p1, int p2) {}
void __stdcall EnclaveCopyOutOfEnclave(int p0, int p1, int p2) {}
void __stdcall EnclaveEncryptDataForTrustlet(int p0, int p1, int p2, int p3, int p4, int p5) {}
...
void __stdcall EnclaveRestrictContainingProcessAccess(int p0, int p1) {}
...
void __stdcall EnclaveUsesAttestedKeys() {}
