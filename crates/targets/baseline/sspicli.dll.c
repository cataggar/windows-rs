...
void __stdcall SecAllocateAndSetCallTarget(int p0, int p1, int p2, int p3) {}
void __stdcall SecAllocateAndSetIPAddress(int p0, int p1, int p2) {}
void __stdcall SecFreeCallContext() {}
